						...
						<div class="card-body">
	                        <div class="form-group row">
	                            <label for="incremento_anio" class="col-sm-3 col-form-label">Porcentaje de incremento
	                                año</label>
	                            <div class="col-sm-6">
	                                <input type="number" class="form-control" id="incremento_anio" placeholder="Porcentaje" min="0" max="100"
	                                    required>
	                                ...
	                                <div class="table-responsive">
	                                    <table id="tabla" class="table table-bordered table-striped">
	                                        ...
	                                        <tr class="fila-fija">
	                                            ...
	                                            <td><input id="garaEnero" class="form-control" required
	                                        ...
	                                        <tr class="fila-fija">
	                                            ...
	                                            <td><input id="garaFebrero" class="form-control" required
	                                                    name="garantiaMes[]" placeholder="" />
	                                            </td>
	                                        ...
	                                        <tr class="fila-fija">
	                                            ...
	                                            <td><input id="garaMarzo" class="form-control" required
	                                                    name="garantiaMes[]" placeholder="" />
	                                            </td>
	                                        ...
	                                        <tr class="fila-fija">
	                                            ...
	                                            <td><input id="garaAbril" class="form-control" required
	                                                    name="garantiaMes[]" placeholder="" />
	                                            </td>
	                                        ...
	                                        <tr class="fila-fija">
	                                            ...
	                                            <td><input id="garaJunio" class="form-control" required
	                                                    name="garantiaMes[]" placeholder="" />
	                                            </td>
	                                        ...
	                                        <tr class="fila-fija">
	                                            ...
	                                            <td><input id="garaJulio" class="form-control" required
	                                                    name="garantiaMes[]" placeholder="" />
	                                            </td>
	                                        ...
	                                        <tr class="fila-fija">
	                                            ...
	                                            <td><input id="garaAgosto" class="form-control" required
	                                                    name="garantiaMes[]" placeholder="" />
	                                            </td>
	                                        ...
	                                        <tr class="fila-fija">
	                                            ...
	                                            <td><input id="porSeptiembre" class="form-control" required
	                                                    placeholder="%" /></td>

	                                            <td><input id="venSeptiembre" class="form-control" required
	                                                    name="ventasMes[]" placeholder="" />
	                                            </td>
	                                            <td><input id="proSeptiembre" class="form-control" required
	                                                    name="promosMes[]" placeholder="" />
	                                            </td>
	                                            <td><input id="garaSeptiembre" class="form-control" required
	                                                    name="garantiaMes[]" placeholder="" />
	                                            </td>
	                                            <td><input id="totSeptiembre" class="form-control" required
	                                                    name="totalMes[]" placeholder="" />
	                                            </td>
	                                            <!-- <td class="eliminar"><input type="button" value="Menos -" /></td> -->
	                                        </tr>
	                                        <tr class="fila-fija">
	                                            ...
	                                            <td><input id="garaOctubre" class="form-control" required
	                                                    name="garantiaMes[]" placeholder="" />
	                                            </td>
	                                        ...
	                                        <tr class="fila-fija">
	                                            ...
	                                            <td><input id="porNoviembre" class="form-control" required
	                                                    placeholder="%" /></td>

	                                            <td><input id="venNoviembre" class="form-control" required
	                                                    name="ventasMes[]" placeholder="" />
	                                            </td>
	                                            <td><input id="proNoviembre" class="form-control" required
	                                                    name="promosMes[]" placeholder="" />
	                                            </td>
	                                            <td><input id="garaNoviembre" class="form-control" required
	                                                    name="garantiaMes[]" placeholder="" />
	                                            </td>
	                                            <td><input id="totNoviembre" class="form-control" required
	                                                    name="totalMes[]" placeholder="" />
	                                            </td>
	                                            <!-- <td class="eliminar"><input type="button" value="Menos -" /></td> -->
	                                        </tr>
	                                        <tr class="fila-fija">
	                                            ...
	                                            <td><input id="porDiciembre" class="form-control" required
	                                                    placeholder="%" /></td>

	                                            <td><input id="venDiciembre" class="form-control" required
	                                                    name="ventasMes[]" placeholder="" />
	                                            </td>
	                                            <td><input id="proDiciembre" class="form-control" required
	                                                    name="promosMes[]" placeholder="" />
	                                            </td>
	                                            <td><input id="garaDiciembre" class="form-control" required
	                                                    name="garantiaMes[]" placeholder="" />
	                                            </td>
	                                            <td><input id="totDiciembre" class="form-control" required
	                                                    name="totalMes[]" placeholder="" />
	                                            </td>
	                                            <!-- <td class="eliminar"><input type="button" value="Menos -" /></td> -->
	                                        </tr>
