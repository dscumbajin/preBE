...
if (empty($_POST['mod_id'])) {
	...
	$id_linea = mysqli_real_escape_string($con, (strip_tags($_POST['mod_id'], ENT_QUOTES)));

	$sql = "UPDATE listalinea SET nomLinea='" . $nombre . "', estadoLinea='" . $estado . "' WHERE codLinea='" . $id_linea . "'";
	$query_update = mysqli_query($con, $sql);
	if ($query_update) {
		$messages[] = "Linea de negocio actualizada satisfactoriamente.";
	} else {
