...
/*Inicia validacion del lado del servidor*/
 if (empty($_POST['mod_nombre'])) {
	$errors[] = "Descripción de segmento vacío";
} else if (
	...
	$id_segmento = intval($_POST['mod_id']);

	$sql = "UPDATE segmento SET desSeg='" . $nombre . "' WHERE codSeg='" . $id_segmento . "'";
	$query_update = mysqli_query($con, $sql);
	if ($query_update) {
		$messages[] = "Segmento actualizado satisfactoriamente.";
	} else {
