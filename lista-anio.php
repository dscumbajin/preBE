...
<script>
    ...
    function Registrar_Excel() {
        ...
        var arreglo_ventasPresU = new Array();
        var arreglo_promoPresU = new Array();
        var arreglo_garantPresU = new Array();
        var arreglo_totalPresU = new Array();
        ...
        $("#tabla_detalle tbody#tbody_tabla_detalle tr").each(function() {
            ...
            arreglo_ventasPresU.push($(this).find('td').eq(3).text());
            arreglo_promoPresU.push($(this).find('td').eq(4).text());
            arreglo_garantPresU.push($(this).find('td').eq(5).text());
            arreglo_totalPresU.push($(this).find('td').eq(6).text());
            contador++;
        });
        if (contador == 0) {
        ...
        var ventasPresU = arreglo_ventasPresU.toString();
        var promoPresU = arreglo_promoPresU.toString();
        var garantPresU = arreglo_garantPresU.toString();
        var totalPresU = arreglo_totalPresU.toString();

        $.ajax({
            url: 'controlador_anio.php',
            type: 'POST',
            data: {
                codVen: codVen,
                codLinea: codLinea,
                anio: anio,
                ventasPresU: ventasPresU,
                promoPresU: promoPresU,
                garantPresU: garantPresU,
